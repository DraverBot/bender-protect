...
export default new Process('get time', async({ interaction, user, time = 120000, embed = timeQuestion(user) }: { interaction: CommandInteraction; user: User; time?: number; embed?: EmbedBuilder}) => {
