    ...
    interaction.editReply({
        embeds: [
            classic(interaction.user, { accentColor: true, footerText: 'client' })
                .setTitle('Guide')
                .setDescription(
                    `Voici le guide d'utilisation de ${pingUser(
                        client.user
                        ...
                        'draver'
                    )}) permet de faire des actions de modération avec un bot, tout en conservant la protection. En effet, [Draver](${util(
                        'draver'
                    )}) est connecté à Bender Protect, ce qui fait que la moindre action effectuée avec Draver sera transmise à Bender Protect pour être vérifiée.\n\n### Sanctions\nLes sanctions applicables lorsque quelqu'un fait une action qu'il n'a pas le droit de faire sont les suivantes :\n- Bannissement\n- Bannissement temporaire\n- Expulsion\n- Destitution des rôles de modération\n\nPour configurer la sanction appliquée, vous devez utiliser la commande ${commandName(
                        'sanctions'
                    )}, utilisable seulement par le propriétaire du serveur.\n### Entre autres\nBender Protect est doté de commandes que vous pouvez utiliser pour gérer votre serveur, telle que ${commandName(
                        'tempban'
                    )}, ${commandName(
                        'mute'
                        ...
                        .join(
                            '\n'
                        )}\n### GBan\nBender Protect possède également un système de bannissement global, partagé avec Draver, qui bannira quiconque appartient à cette liste lorsqu'il essaiera de rejoindre le serveur. Vous pouvez désactiver cette fonctionnalité en utilisant la commande ${commandName(
                        'configurer'
                    )}.\nUn système de mode raid est également présent, c'est un système qui permet d'empêcher tout les utilisateurs de rejoindre le serveur, que vous pouvez activer via la commande ${commandName(
                        'configurer'
                    )}\nUn système d'antispam est également intégré au bot, vous pouvez régler tout les paramètres de l'antispam en utilisant la commande ${commandName(
                        'configurer'
                    )}`
                )
                .setFields({
